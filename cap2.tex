...
\begin{frame}[fragile]{Customer} 
	\begin{itemize}[<+- | alert@+>]
		...
		\end{itemize}		 
		\item Advanced Metering Infrastructure  % sistema che integra smart meter, display, termostati ecc., reti di comunicazione verso i concentratori di dati e sistemi di gestione dei dati
		\begin{itemize}
