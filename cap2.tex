...
% applicazioni di un dominio devonocollegati poter comunicare con altre di altri domini rispetto requisiti di sicurezza (confidentiality, integrity ecc. Compromissioni di una rete non deve compromettere le altre)

% ISO is an Independent System Operator and an RTO is a Regional Transmission Organization
\begin{frame}[fragile]{Architettura}
	\vspace{-10pt}
	\begin{figure}[h] 
...
% Una substation elettrica è un punto di riferimento dei sistemi di generazione, trasmissione e distribuzione, dove il voltaggio viene trasformato da alto a basso e viceversa mediante trasformatori. Ci sono diversi tipi di substation: trasmissione, distribuzione, raccolta, smistamento.
\begin{frame}[fragile]{Transmission}
