	...
	\begin{itemize}[<+- | alert@+>]
		...
		\item Digest con OMAK su
			\footnotesize{			
				\begin{table}[!h]
					\centering
				\hspace*{-25pt}\begin{tabular}{|l|l|l|l|l|l|}
						\hline
						Subnet (1 byte) & Node (1 byte) & Request & Sequence & Response & Response Length \\ \hline % response length (1 byte)
					\end{tabular}
				\end{table}
			}
	\end{itemize}
...
\begin{frame}{Principali vulnerabilità delle Smart Grid: OSGP - Encryption Scheme}
	\begin{figure}[t]
...
\begin{frame}{Principali vulnerabilità delle Smart Grid: attacchi e contromisure}
	...
	\begin{itemize}
		\item Misura sotto attacco non stealth: $\textbf{z}^\prime = \textbf{H}(\textbf{x})\footnotemark[1] + \textbf{b} + e$
	...
	\begin{itemize}
		\item Misura sotto attacco stealth: $\textbf{z}^\prime = \textbf{H}(\textbf{x} + \delta\textbf{x})\footnotemark[1] + e$
		\item Non rilevabile usando meccanismi a soglia
	\end{itemize}
\end{itemize}
\footnotetext[1]{Si intende: \emph{matrice} $\times$ \emph{vettore}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
