...
\begin{frame}{Standard e tecnologie: Sommario}
	\begin{itemize}
		\alert<1>{\item Tecnologie di comunicazione}
		\begin{itemize}
			\alert<1>{\item IEEE 802}
			\begin{itemize}
				\alert<1>{\item Ethernet}
				\alert<1>{\item Wireless}
				\alert<1>{\item Bluetooth}
				\alert<1>{\item ZigBee \& 6LoWPAN}
				\alert<1>{\item WiMAX}
			\end{itemize}
			\alert<1>{\item Power Line Communication}
		\end{itemize}
		\item Standard per lo scambio di informazioni
		\begin{itemize}
			\item Modbus
...
\begin{frame}{Standard e tecnologie: Sommario}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Power Line Communication
		\end{itemize}
		\alert<1>{\item Standard per lo scambio di informazioni}
		\begin{itemize}
			\alert<1>{\item Modbus}
			\alert<1>{\item ISO/IEC 61850}
		\end{itemize}
		\item Standard per la sicurezza
		\begin{itemize}
			\item ISO/IEC 62351
...
\begin{itemize}[<+- | alert@+>]
	...
	\begin{itemize}[<+- | alert@+>]
		...
		%Utilizzato per lo scambio di informazioni sui soli cambiamenti di stato. In questo caso i messaggi sono costituiti da una serie di bit che rappresentano liste di stati. GSSE necessita un tempo di trasmissione maggiore se confrontato con GOOSE
	\end{itemize}
...
\begin{frame}{Standard e tecnologie: Sommario}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item ISO/IEC 61850
		\end{itemize}
		\alert<1>{\item Standard per la sicurezza}
		\begin{itemize}
			\alert<1>{\item ISO/IEC 62351}
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}{Standard per la sicurezza}
	...
	\begin{enumerate}[<+- | alert@+>]
		...
		%Fornisce una introduzione alle restanti parti della serie IEC 62351, in primo luogo per introdurre il lettore a diversi aspetti della sicurezza delle informazioni applicata alle operazioni del power system
		\item Glossary of terms
		%Comprende i principali termini utilizzati nella serie IEC 62351, e non vuole essere un elenco definitivo. La maggior parte dei termini utilizzati per la sicurezza informatica sono formalmente definiti da altri organismi e quindi sono inclusi qui con riferimenti a chi li ha definiti
		\item Communication network and system security - Profiles including TCP/IP
		%Specifica come fornire riservatezza, il rilevamento di manomissione, e l'autenticazione a livello di messaggio per i protocolli SCADA e di telecontrollo che fanno uso di TCP/IP come message transport layer
		...
		%Specifica messaggi, procedure e algoritmi per la sicurezza delle operazioni dei protocolli basati su IEC 60870-5 e derivati (60870-5-101-104)
		...
		%Specifica messaggi, procedure e algoritmi per garantire il funzionamento di tutti i protocolli basati su 61850 e derivati
		%Profili 61850 per la comunicazione non basati su TCP/IP
		\item Network and system management (NSM) data object models
		%Definisce i data object model (NSM) specifici per il funzionamento del sistema di alimentazione
		%Questi data object NSM sono utilizzati per monitorare la salute delle reti e dei sistemi, per rilevare eventuali intrusioni, e per gestire le prestazioni e l'affidabilità dell'infrastruttura relativa alle informazioni
		%implementa o estende sistemi di intrusion detection
